...
def load_scenario(scenario_file):
    ...
    observation = np.asarray([[scenario_mapping[char] for char in list(line)] for line in map.split('\n')])
...
def load_agent(state_size ):
    ...
    weight_file =  '../state/last_model_weights.h5' #constants.state_pattern.format(filename=constants.WEIGHTS_FILE)
